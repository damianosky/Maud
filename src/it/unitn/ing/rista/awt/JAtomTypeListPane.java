 ...
 *
 * This software is the research result of the author and it is provided as it
 * is as confidential and proprietary information. You shall not disclose such
 * Confidential Information and shall use it only in accordance with the terms
 * of the license agreement you entered into with the author.
 *
...
public class JAtomTypeListPane extends JSubordListPane {
  ...
  public void showInfoPanel() {
    ...
    /*
     * for (int i = 0; i < plotCounts; i++) { x[i] = xstart + i * xstep; y[i] =
     * XRayDataSqLite.getPhotoAbsorptionForAtomAndEnergyDiv(atomicNumber, x[i]);
     * if (y[i] > 0) y[i] = MoreMath.log10(y[i]); else y[i] = 0; } (new
     * PlotSimpleData(getFrameParent(), x, y)).setVisible(true);
     */
